    ...
    <div className="overflow-hidden">
      <div className="pt-20 bg-sidekick-green">
        <div className="px-6 md:px-0 py-16 flex items-center justify-between max-w-7xl mx-auto md:w-[80vw]">
          <h2 className="text-3xl font-bold md:text-6xl md:font-semibold text-gray-800 tracking-tight">
            Contact Us
          </h2>
          <ArrowDown
            size={36}
            className="text-white bg-sidekick-blue w-20 h-20 p-4 rounded-full"
          />
        </div>
      </div>
      ...
      <section className=" space-y-6 md:space-y-12 relative max-w-7xl mx-auto  py-12 px-6 md:px-0">
        ...
        <div className="relative w-max mx-auto">
          ...
          <img
            ...
            alt=""
            aria-hidden
            className="hidden md:block relative select-none ml-auto left-6 bottom-3"
          />
        </div>
        ...
        <div className="flex flex-col gap-8 py-4 md:py-0 items-center justify-between md:grid md:grid-cols-3 md:gap-2 place-items-center max-w-5xl mx-auto mb-12">
          <div>
            ...
            <a
              href="mailto:admin@gosidekick.in"
              className="block mb-1 text-lg font-semibold"
            >
              admin@gosidekick.in
            </a>
            <p className="text-center text-sm md:font-normal font-medium text-gray-500">
              Email
            </p>
          </div>
          <div>
