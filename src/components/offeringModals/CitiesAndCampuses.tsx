...
import modalImg from '../../assets/offerings/CitiesAndCampuses.png'
        ...
        <div className='px-6 max-w-md grow'>
          ...
          <div className='space-y-4'>
            ...
            <div className='flex items-start gap-2'>
              ...
              <p className='text-zinc-700 leading-snug text-lg'>Just pause, scan, and take off.
              </p>
            </div>
            ...
            <div className='flex items-start gap-2'>
              ...
              <p className='text-zinc-700 leading-snug text-lg'>Give your feet and wallet a break.
              </p>
            </div>
          </div>
        </div>
...
export default CitiesAndCampuses