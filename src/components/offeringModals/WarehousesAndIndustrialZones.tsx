    ...
    <div className='p-5 flex items-stretch max-w-[80vw] w-max max-h-[90vh]'>
      ...
      <div className='grow flex flex-col'>
        ...
        <div className='px-6 max-w-md grow'>
          <h2 className="text-4xl font-bold text-center text-zinc-800 mb-2">Warehouses & Industrial Zones</h2>
          <p className='text-sidekick-blue text-2xl rounded-lg px-7 font-semibold my-6 py-4 bg-[#F5F9FF]'>We make every step of your day quicker.</p>
          ...
          <div className='space-y-4'>
            <div className='flex items-start gap-4'>
              ...
              <p className='text-zinc-700 leading-snug text-lg'>
                From Workstation to Workstation, No Time Wasted. Sidekick transforms workforce mobility.
              </p>
            </div>
            ...
            <div className='flex items-start gap-2'>
              ...
              <p className='text-zinc-700 leading-snug text-lg'>
                Allowing employees to move faster, safer, and more efficiently.
              </p>
            </div>
            ...
            <div className='flex items-start gap-2'>
              ...
              <p className='text-zinc-700 leading-snug text-lg'>
                Speeds up your intra-campus mobility.
              </p>
            </div>
          </div>
        </div>
